...
function placeTask(task, { facultyById, facultyUse, sectionUse, yearBlocks, settings }, allowCrossProgramFallback = false) {
  ...
  return { placed: null, error: { task, type: 'no-slot', reason: `No conflict-free slot within Year ${task.subject.yr} ${block.label} (${timeLabel(block.start)}-${timeLabel(block.end)})` } }
}
