      ...
      <section className="overflow-hidden rounded-2xl border border-emerald-950/10 bg-white shadow-sm">
        <div className="flex flex-wrap items-center gap-3 px-5 py-4" style={{ background: finalized ? 'linear-gradient(105deg,#065F46,#059669)' : `linear-gradient(105deg, ${FOREST}, ${MID_GREEN})` }}>
          ...
          {finalized ? (
            ...
            <button type="button" onClick={finalize} disabled={!canFinalize} className="flex items-center gap-2 rounded-lg px-3 py-2 text-xs font-black text-emerald-950 disabled:opacity-45" style={{ background: GOLD }}>
        ...
        <div className="grid gap-4 p-5 lg:grid-cols-[1fr_320px]">
          <div className="overflow-hidden rounded-xl border border-emerald-950/10">
            <div className="border-b border-emerald-950/10 bg-emerald-950/[0.03] px-4 py-3">
              <p className="text-sm font-black text-emerald-950">Generated Schedule</p>
